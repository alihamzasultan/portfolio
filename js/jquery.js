!(function (global, factory) {
                      ...
                      (useCache &&
                        (diff = nodeIndex =
                          (cache =
                            (uniqueCache =
                              (outerCache =
                                (node = elem)[expando] || (node[expando] = {}))[
                                node.uniqueID
                              ] || (outerCache[node.uniqueID] = {}))[type] ||
                            [])[0] === dirruns && cache[1]),
                      !1 === diff)
  ...
  (jQuery.Callbacks = function (options) {
    ...
    var firing,
      ...
      fire = function () {
        for (
          locked = options.once, fired = firing = !0;
          queue.length;
          firingIndex = -1
        )
  ...
  (jQuery.event = {
    ...
    handlers: function (event, handlers) {
      ...
      if (
        delegateCount &&
        cur.nodeType &&
        ("click" !== event.type || isNaN(event.button) || event.button < 1)
      )
      ...
      if (
        ...
        for (
          ...
          (src = srcElements[i]),
            (dest = destElements[i]),
            (nodeName = void 0),
            "input" === (nodeName = dest.nodeName.toLowerCase()) &&
    ...
    return (
      display ||
        (("none" !== (display = actualDisplay(nodeName, doc)) && display) ||
          ...
          ).appendTo(doc.documentElement))[0].contentDocument).write(),
          doc.close(),
    ...
    prefilters: [
      function defaultPrefilter(elem, props, opts) {
        ...
        if (jQuery.isEmptyObject(orig))
          ...
          anim.done(function () {
            var prop;
            for (prop in (dataPriv.remove(elem, "fxshow"), orig))
        ...
        attrHandle[name] = function (elem, name, isXML) {
          ...
          return (
            isXML ||
              ...
              (attrHandle[name] = ret),
              (ret =
                null != getter(elem, name, isXML) ? name.toLowerCase() : null),
      ...
      if ("string" == typeof value && value)
        for (classes = value.match(rnotwhite) || []; (elem = this[i++]); )
          if (
            ...
            curValue !== (finalValue = jQuery.trim(cur)) &&
  ...
  (jQuery.fn.load = function (url, params, callback) {
    ...
    return (
      off > -1 &&
        ((selector = jQuery.trim(url.slice(off))), (url = url.slice(0, off))),
